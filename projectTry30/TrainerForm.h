...
namespace GymManagementSystem {
    ...
    public ref class TrainerForm : public System::Windows::Forms::Form {
    public:
        TrainerForm() {
            try {
                InitializeComponent();
                ...
                MessageBox::Show("TrainerForm Initialization Error: " + ex->Message + "\nStack Trace: " + ex->StackTrace, "Error");
            }
        }
    ...
    private:
        ...
        void InitializeComponent() {
            try {
                ...
                this->btnAdd->Click += gcnew System::EventHandler(this, &TrainerForm::OnAddClick);

                this->btnEdit->Text = "Edit";
                this->btnEdit->Location = System::Drawing::Point(160, 450);
                this->btnEdit->Size = System::Drawing::Size(100, 30);
                this->btnEdit->Click += gcnew System::EventHandler(this, &TrainerForm::OnEditClick);

                this->btnDelete->Text = "Delete";
                this->btnDelete->Location = System::Drawing::Point(270, 450);
                this->btnDelete->Size = System::Drawing::Size(100, 30);
                this->btnDelete->Click += gcnew System::EventHandler(this, &TrainerForm::OnDeleteClick);
        ...
        void LoadData() {
            try {
                dataGridView->DataSource = DatabaseHelper::GetAllTrainers();
            }
            catch (Exception^ ex) {
        ...
        void OnAddClick(System::Object^ sender, System::EventArgs^ e) {
            try {
                AddEditTrainerForm^ form = gcnew AddEditTrainerForm(nullptr);
        ...
        void OnEditClick(System::Object^ sender, System::EventArgs^ e) {
            try {
                if (dataGridView->SelectedRows->Count > 0) {
                    ...
                    AddEditTrainerForm^ form = gcnew AddEditTrainerForm(selectedRow);
                    if (form->ShowDialog() == System::Windows::Forms::DialogResult::OK) {
                        LoadData();
                    }
                }
        ...
        void OnDeleteClick(System::Object^ sender, System::EventArgs^ e) {
            try {
                if (dataGridView->SelectedRows->Count > 0) {
                    ...
                    if (MessageBox::Show("Are you sure you want to delete this trainer?",
