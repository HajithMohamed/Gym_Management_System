...
#include "AddEditEquipmentForm.h"
    ...
    public:
        EquipmentForm() {
            try {
                ...
                MessageBox::Show("EquipmentForm Initialization Error: " + ex->Message + "\nStack Trace: " + ex->StackTrace, "Error");
            }
        }
    ...
    private:
        ...
        void InitializeComponent() {
            try {
                ...
                this->btnAdd->Click += gcnew System::EventHandler(this, &EquipmentForm::OnAddClick);

                this->btnEdit->Text = "Edit";
                this->btnEdit->Location = System::Drawing::Point(160, 450);
                this->btnEdit->Size = System::Drawing::Size(100, 30);
                this->btnEdit->Click += gcnew System::EventHandler(this, &EquipmentForm::OnEditClick);

                this->btnDelete->Text = "Delete";
                this->btnDelete->Location = System::Drawing::Point(270, 450);
                this->btnDelete->Size = System::Drawing::Size(100, 30);
                this->btnDelete->Click += gcnew System::EventHandler(this, &EquipmentForm::OnDeleteClick);
        ...
        void LoadData() {
            try {
                dataGridView->DataSource = DatabaseHelper::GetAllEquipment();
            }
            catch (Exception^ ex) {
        ...
        void OnAddClick(System::Object^ sender, System::EventArgs^ e) {
            try {
                AddEditEquipmentForm^ form = gcnew AddEditEquipmentForm(nullptr);
        ...
        void OnEditClick(System::Object^ sender, System::EventArgs^ e) {
            try {
                if (dataGridView->SelectedRows->Count > 0) {
                    ...
                    AddEditEquipmentForm^ form = gcnew AddEditEquipmentForm(selectedRow);
                    if (form->ShowDialog() == System::Windows::Forms::DialogResult::OK) {
                        LoadData();
                    }
                }
